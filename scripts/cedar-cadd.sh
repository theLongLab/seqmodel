...
#SBATCH --output=seqbert-cadd-%j.out  # file name for the output
#SBATCH --error=seqbert-cadd-%j.err   # file name for errors
                                        # %j gets replaced by the job number

## project name
NAME_DIR=seqbert-cadd
